...
//		sim.addExporter(imageExporter);			
        ...
        BSimLogger AI_internal_logger_ALL = new BSimLogger(sim, filePath + "AI_internal_ALL.csv") {
            ...
            public void during() {
                ...
                for (int i = 0, n = bacteria.size(); i < n; i++) {
                    buffer.append(",").append(bacteria.elementAt(i).y[6]);
                }
                write(o + buffer);
            }
        };
        ...
        System.out.println("octave --persist matlab_plotter/bsim_plot.m " + filePath + "lacI_ALL.csv " + filePath + "AI_internal_ALL.csv ");
    }
}
