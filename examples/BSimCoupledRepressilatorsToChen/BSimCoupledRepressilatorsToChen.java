package BSimCoupledRepressilatorsToChen;
 ...
 */
public class BSimCoupledRepressilatorsToChen {
	 ...
	 public static void main(String[] args) {
		...
		class BSimRepressilatorBacterium extends BSimBacterium {
			...
			class QuorumRepressilator implements BSimOdeSystem{
				...
				//Ideja:
				/*
				Prepišemo obstoječi ODE z DDE ?
				BSimChenOscillator/grn/RepressorDDE - kaj uporabimo? Tudi ActivatorDDE?
				Kaj vse je potrebno spremeniti?
				- class naj implementira BSimDdeSystem sklepam
				- čeprav: glej RepressorDDE.java -> getRate() piše da je to ODE ??
				 */
